...
@Component({
  template: `
    ...
    <div #target zxHeightObserver [targetElement]="target" [isDocumentHeight]="isDocumentHeight"
         [fixedHeight]="fixedHeight">Target
    </div>
  `,
...
describe("HeightObserverDirective", () => {
  ...
  it("should not update target height when neither document height nor fixed height is specified", fakeAsync(() => {
    ...
    expect(console.warn)
      .toHaveBeenCalledWith("Neither parent height nor fixed height is specified.");
